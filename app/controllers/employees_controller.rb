class EmployeesController < ApplicationController
  ...
  wrap_parameters :employee, include: [:global_max_hours, :email, :name, :is_disabled, :profile, :organization_id, :employee_availabilities_attributes, :location_assignments_attributes, :skill_assignments_attributes, :shift_assignments_attributes]
  respond_to :json
